...
The 0.2.1 CLI writes `cli_version` 0.2.1 and continues to accept exact
0.1.0-, 0.1.1-, 0.1.2-, 0.1.3-, 0.1.4-, and 0.2.0-created manifests. Any
other or unknown CLI manifest version is invalid.
